...
def main():
    ...
    guardian_cls = load_classified(os.path.join(DATA_DIR, 'news_guardian_classified.json'))
    nyt_cls = load_classified(os.path.join(DATA_DIR, 'news_nyt_classified.json'))
    naver_cls = load_classified(os.path.join(DATA_DIR, 'news_naver_classified.json'))
