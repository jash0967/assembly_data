...
OUTPUT_ARTICLES = os.path.join(config.BILLS_EU_DIR, "eu_ai_act_articles.json")
OUTPUT_CLASSIFIED = os.path.join(config.BILLS_EU_DIR, "eu_ai_act_classified.json")
HTML_CACHE = os.path.join(config.BILLS_EU_DIR, "eu_ai_act_raw.html")
