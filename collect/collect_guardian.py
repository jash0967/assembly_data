...
OUTPUT_RAW = os.path.join(config.NEWS_DIR, "guardian_articles_raw.json")
...
def main():
    ...
    print(f"\nCollected {len(articles)} articles. Run 'python classify_articles.py guardian' to classify.", flush=True)
