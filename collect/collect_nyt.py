...
분류는 별도 스크립트 classify_articles.py 사용:
    python classify_articles.py nyt
...
ARCHIVE_DIR = os.path.join(config.NEWS_DIR, "nyt_archive")
OUTPUT_RAW = os.path.join(config.NEWS_DIR, "nyt_articles_raw.json")
...
def main():
    ...
    print(f"\nCollected {len(articles)} articles. Run 'python classify_articles.py nyt' to classify.", flush=True)
