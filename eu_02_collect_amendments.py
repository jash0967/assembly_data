...
HTML_CACHE = os.path.join(DATA_DIR, "eu_amendments_raw.html")
OUTPUT_AMENDMENTS = os.path.join(DATA_DIR, "eu_amendments.json")
OUTPUT_CLASSIFIED = os.path.join(DATA_DIR, "eu_amendments_classified.json")
